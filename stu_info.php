...
<table class="table table-bordered"  style="{border:1px;border-style:solid;border-color:black;}">
<tr><th>SSC Percentage</th><th>PUC CGPA</th><th>E1 CGPA</th><th>E2 CGPA</th><th>E3 CGPA</th><th>E4 CGPA</th></tr>
<tr><th>82.66%</th><th>8.45</th><th>8.23</th><th>8.28</th><th>8.00</th><th>E4 CGPA</th></tr>
</table>
</fieldset>

<fieldset style="{margin-left:75;margin-right:75;}"><legend><b>Communication Details</b></legend>
<table class="table table-bordered" style="{border:1px;border-style:solid;border-color:black;}">
<tr><td>Permanent Address:</td><td><?php echo $row['permanent_addr'];?></td></tr>
<tr><td>Present Address:</td><td><?php echo $row['present_addr'];?></td></tr>

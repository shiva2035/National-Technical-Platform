...
else
{
	...
	?>
		...
		<tr><td>Add Attachment:</td><td id=file><input type="text" readonly="true" value="<? echo $srow['link'];?>"><input type="button" onclick="loadFile()" value="Attach File" class="btn btn-info"></td></tr>
